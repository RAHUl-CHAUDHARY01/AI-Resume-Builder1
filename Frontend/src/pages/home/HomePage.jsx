...
function HomePage() {
  ...
  const handleClick = () => {
    window.open(
      "https://github.com/devanshvashistha",
      "_blank"
    );
  };
...
<footer className="bg-white border-t border-gray-200" aria-labelledby="footer-heading">
  <div className="mx-auto max-w-7xl px-6 py-8 relative">
    <div className="flex items-center justify-between">
      ...
      {/* Center */}
      <p className="absolute left-1/2 -translate-x-1/2 text-sm font-medium text-gray-600">
        Made By <span className="text-gray-900 font-semibold">Devansh Vashistha</span>
      </p>
